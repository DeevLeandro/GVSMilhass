...
export function Hero({ onStart }) {
  ...
  return (
    /*
     * SEM overflow: hidden aqui — esse era o bug principal.
     * O overflow cortava o grid antes de a altura ser calculada.
     * O overflow está em .hero-right no CSS (apenas no carrossel).
     *
     * SEM position: relative aqui — desnecessário no pai do grid
     * e interagia mal com o cálculo de altura no Safari.
     */
    <div className="hero-root" style={{ background: '#0A0A0A', fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="hero-left">
        ...
        <div>
          <p style={{
            ...
            textTransform: 'uppercase', color: '#A8874A', display: 'inline-block',
          }}>
            GVS · Gestão de Milhas
          </p>
          <div style={{ width: 55, height: 1, background: '#A8874A', marginTop: 12 }} />
        </div>
        ...
        <div style={{ maxWidth: 480 }}>
          <p style={{
            ...
            textTransform: 'uppercase', color: 'rgba(168,135,74,0.65)', marginBottom: 24,
          }}>
            Pré-Cadastro de Cliente
          </p>

          <h1 className="hero-h1">
            Viagens que<br />poucos vivem.
            <span style={{ display: 'block', fontStyle: 'italic', color: '#D4B896', marginTop: 8 }}>
              Você merece.
            </span>
          </h1>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16, alignItems: 'flex-start' }}>
            <button
              onClick={onStart}
              style={{
                background: '#A8874A', color: '#fff', border: 'none', borderRadius: 2,
        ...
        {/* Rodapé */}
        <div style={{
          borderTop: '1px solid rgba(168,135,74,0.15)', paddingTop: 28,
          ...
          <div style={{ display: 'flex', gap: 48 }}>
            {[
              ...
              <div key={item.label}>
                ...
                <p style={{ fontFamily: "'Playfair Display', serif", fontSize: 14, fontWeight: 400, color: '#D4B896' }}>
                  {item.value}
                </p>
              </div>
            ))}
          ...
          <a
            ...
            style={{
              ...
              border: '1px solid rgba(74,168,79,0.25)', borderRadius: 2, padding: '8px 16px',
              transition: 'all 0.2s',
            }}
      ...
      <div className="hero-right">
            ...
            {!isMobile && (
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
                  <div style={{
                    width: 32, height: 1, background: '#A8874A',
                    transform: activeIndex === idx ? 'scaleX(1)' : 'scaleX(0)',
                    transformOrigin: 'left', transition: 'transform 0.5s ease 0.4s',
                  }} />
                  <span style={{ fontSize: 11, fontWeight: 400, letterSpacing: '0.14em', textTransform: 'uppercase', color: '#A8874A' }}>
                    Experiencias Reais
                  </span>
                </div>
        ...
        <button
          ...
          onMouseEnter={e => { e.currentTarget.style.background = 'rgba(168,135,74,0.3)'; e.currentTarget.style.borderColor = '#A8874A' }}
